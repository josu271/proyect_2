    ...
    <section className="space-y-8">
      <div className="rounded-3xl bg-gradient-to-r from-blue-600 to-indigo-700 p-8 text-white shadow-xl">
        ...
        <p className="mt-2 max-w-2xl text-blue-100">
          Consulta tu horario semanal generado a partir de tu matrícula confirmada.
        </p>
      </div>
        ...
        <div className="mb-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">
              Vista de tus clases por día, hora, docente y aula.
            </p>
          </div>
                  ...
                  {dias.map((dia) => {
                    ...
                    return (
                      <td key={`${dia}-${hora}`} className="align-top">
                        {clase ? (
                          <div className="min-h-32 rounded-2xl border border-blue-200 bg-blue-50 p-4 text-left shadow-sm">
                          ...
                          <div className="flex min-h-32 items-center justify-center rounded-2xl border border-dashed border-slate-200 bg-slate-50 text-xs font-medium text-slate-400">
                            Sin clase
                          </div>
                        )}
                      </td>
      ...
      <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        <h2 className="text-xl font-bold text-slate-900">
          Detalle de clases matriculadas
        </h2>
...
export default MiHorariosestudiante;